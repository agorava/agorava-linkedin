...
/**
 * Model Object passed to getNetworkUpdates() to control what parameters are set on the Http GET request to LinkedIn Network
 * Updates API.
 * 
...
public class NetworkUpdateParameters {
     ...
     */
    public NetworkUpdateParameters(String user, boolean self, int recordStart, int recordCount, Date recordsBefore,
            Date recordsAfter, boolean updateAll, boolean showHidden, UpdateTypeInput... updateTypes) {
