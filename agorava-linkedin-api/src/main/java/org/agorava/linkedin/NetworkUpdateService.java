...
public interface NetworkUpdateService {
     ...
     * <p/>
     * {link NetworkUpdateParameters} for details of each field. Many are left as null to turn off.
     * <p/>
     * As an example. To retrieve last 20 SHAR Updates (Shares) for a particular user:
     * <p/>
     * LinkedInParameters parameters = new LinkedInParameters( "VALID_ID", true, 0, 20, null, null, false, false,
     * Collections.<UpdateTypeInput>singletonList(UpdateTypeInput.SHAR)); List<LinkedInNetworkUpdate> updates =
     * linkedIn.getNetworkUpdates(parameters);
     *
    ...
    /**
     * Advanced retrieval of network updates for connections or self in JSON format rather than object. Useful for debugging.
     * <p/>
    ...
    /**
     * Get list of comments on a Network Update. updateKey must be a valid key from linkedIn. e.g
     * UNIU-2481200-5541820536390100000-SHARE
     *
     * @param updateKey
    ...
    /**
     * Get list of likes on a Network Update. updateKey must be a valid key from linkedIn. e.g
     * UNIU-2481200-5541820536390100000-SHARE
     *
     * @param updateKey
